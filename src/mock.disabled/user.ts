...
// 登录接口
Mock.mock('/api/auth/login', 'post', function (options: MockjsRequestOptions) {
...
// 获取用户信息接口
Mock.mock(new RegExp('/api/auth/user-info.*'), 'get', function (options: MockjsRequestOptions) {
...
// 登出接口
Mock.mock('/api/auth/logout', 'post', function () {
...
// 获取用户列表接口
Mock.mock('/api/system/user/list', 'get', function () {
...
// 获取角色列表接口
Mock.mock('/api/system/roles', 'get', function () {
