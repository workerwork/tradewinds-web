...
interface AuthAPI {
    ...
    changePassword(data: { oldPassword: string; newPassword: string }): Promise<ApiResponse<void>> | Promise<void>;
    ...
    getSuperAdminDashboard(): Promise<ApiResponse<SuperAdminDashboard>> | Promise<SuperAdminDashboard>;
}
