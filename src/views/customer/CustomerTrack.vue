<template>
  <div class="customer-track">
    <el-card class="box-card">
      ...
      <el-table v-loading="loading" :data="trackList" style="width: 100%">
    ...
    >
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="跟踪内容" required>
          <el-input v-model="form.content" type="textarea" :rows="4" placeholder="请输入跟踪内容" />
        </el-form-item>
        ...
        <el-form-item label="跟踪时间" required>
          <el-date-picker v-model="form.trackTime" type="datetime" placeholder="选择跟踪时间" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const handleDelete = (row: any) => {
  ElMessageBox.confirm(`确认删除该跟踪记录吗？`, '警告', {
